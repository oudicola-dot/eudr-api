...
def generate_eudr_pdf(audit_id, name, lat, lon, risk_score, risk_level, eudr_compliant, tree_cover, loss_year):
    ...
    content.append(Paragraph(f"<b>Tree Cover:</b> {tree_cover}%", styles["Normal"]))
    ...
    try:
        ...
        pass
    content.append(Spacer(1, 10))
    content.append(Paragraph(f"<b>Verification URL:</b> {verify_url}", styles["Normal"]))
